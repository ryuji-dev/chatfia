export default function PrivacyPolicy() {
  return (
    <section>
      <div className="h-6" />
      <h2 className="mb-4 text-2xl font-semibold">1. 개인정보의 처리 목적</h2>
      <p>
      ...
      <p>
        Chatfia(챗피아)는 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
      ...
      <div className="h-6" />
      <h2 className="mb-4 text-2xl font-semibold">3. 개인정보의 제3자 제공</h2>
      <p>
      ...
      <div className="h-2" />
      <table className="min-w-full border-collapse border border-gray-300 bg-gray-100">
        <thead>
        ...
        <tbody>
          <tr>
            <td className="border-b px-4 py-3 text-center align-middle text-sm">
              OOO
            </td>
            <td className="border-b px-4 py-3 text-center align-middle text-sm">
              본인인증
      ...
      <div className="h-6" />
      <h2 className="mb-4 text-2xl font-semibold">6. 개인정보의 파기</h2>
      <p>
        Chatfia(챗피아)는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
        불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다.
      </p>
      <p>
        회원으로부터 동의 받은 개인정보 보유기간이 경과하거나 처리목적이 달성된
        개인정보는 내부 방침 및 관련 법령에 따라 일정기간 저장된 후 혹은 즉시
        파기됩니다.
      </p>
      <ul className="ml-4 mt-2 list-inside list-disc">
        <li>
          파기절차: 회원이 입력한 정보는 목적 달성 후 별도의 DB에 옮겨져(종이의
          경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 따라 일정기간 저장된
          후 혹은 즉시 파기됩니다.
        </li>
        <li>

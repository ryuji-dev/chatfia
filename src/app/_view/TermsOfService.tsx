  ...
  return (
    <section>
      ...
      <p className="mb-2">
        ...
        이에 부수된 제반 서비스(이하 “게임서비스”)의 이용과 관련하여 회사와 회원
      ...
      <ol className="mb-2 ml-6 list-decimal">
        ...
        <li>
          ...
          가상의 데이터로서 회사가 임의로 책정하고 무료로 지급하는 일체의 재산적
          가치가 없는 것을 말합니다.
        </li>
        <li>
      ...
      <p className="mb-2">
        ...
        화면이나 게임서비스 홈페이지에서 제공하는 이용신청서를 작성하는 방법으로
        이용신청을 하여야 합니다.
      </p>
      <p className="mb-2">
      ...
      <ol className="mb-2 ml-6 list-decimal">
        ...
        <li>
          대한민국 이외의 국가 중 회사에서 아직 서비스를 제공할 것으로 결정하지
          않은 국가에서 서비스를 이용하는 경우
        </li>
      ...
      <p className="mb-2">
        ② 비밀번호의 관리책임은 회원에게 있으며, 회원이 원하는 경우에는 보안상의
        이유 등으로 언제든지 변경이 가능합니다.
      </p>
      <p className="mb-2">③ 회원은 정기적으로 비밀번호를 변경하여야 합니다.</p>
      <div className="h-6" />
      ...
      <ol className="mb-2 ml-6 list-decimal">
        ...
        <li>
          회사가 제공 또는 승인하지 아니한 컴퓨터 프로그램이나 기기 또는 장치를
          제작, 배포, 이용, 광고하는 행위
        </li>
        ...
        <li>
          기타 법령에 위반되거나 선량한 풍속 기타 사회통념상 허용되지 않는 행위
        </li>
      </ol>
      <div className="h-6" />
      ...
      <p className="mb-2">① 회사는 회원에게 게임서비스를 제공할 수 있습니다.</p>
      <p className="mb-2">
      ...
      <ol className="mb-2 ml-6 list-decimal">
        <li>
          설비의 보수점검, 교체, 정기점검 또는 게임 내용의 수정을 위하여 필요한
          경우
        </li>
        <li>
      ...
      <p className="mb-2">
        ① 회원이 직접 구매한 캐쉬의 환불을 요청하면 이를 환불 받을 수 있습니다.
      </p>
      <p className="mb-2">
        ② 현행법령 및 중대한 약관 위반 등 회원의 귀책사유로 이용계약을 해지하는
        경우 환불이 제한될 수 있습니다.
      </p>
      <div className="h-6" />
      ...
      <h3 className="mt-4 text-xl font-semibold">제14조 (회원에 대한 통지)</h3>
      <p className="mb-2">
        ① 회사가 회원에게 통지를 하는 경우 회원이 지정한 전자우편주소 등으로 할
        수 있습니다.
      </p>
      <p className="mb-2">
      ...
      <h3 className="mt-4 text-xl font-semibold">제15조 (재판권 및 준거법)</h3>
      <p className="mb-2">

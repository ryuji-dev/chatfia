export const PrivacyPolicy: React.FC = () => {
  return (
    <div className="container mx-auto py-10">
      <h1 className="mb-6 text-4xl font-bold">개인정보 처리방침</h1>
      ...
      <section className="mb-8">
        ...
        <table className="min-w-full border border-gray-300 bg-zinc-900">
          <thead>
            <tr>
              <th className="border-b py-2">제공받는 자</th>
              <th className="border-b py-2">제공받는 자의 개인정보 이용목적</th>
              <th className="border-b py-2">제공하는 개인정보 항목</th>
          ...
          <tbody>
            <tr>
              <td className="border-b py-2">OOO</td>
              <td className="border-b py-2">본인인증</td>
              <td className="border-b py-2">
                이름, 생년월일, 성별, 아이디, 휴대전화번호
              </td>
              <td className="border-b py-2">회원 탈퇴 시까지</td>
            </tr>
          </tbody>
        </table>
      </section>
